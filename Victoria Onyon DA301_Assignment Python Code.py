...
reviews_negative_sentiment = reviews_negative_sentiment[['product','review', 'summary', 'polarity']]
...
# Review the sentiment of a specific negative response
reviews_negative_sentiment.at[182,'review']
...
# Eliminate unnecessary columns
summary_negative_sentiment = summary_negative_sentiment[['product','review', 'summary', 'polarity']]
...
review_positive_sentiment = review_positive_sentiment[['product','review', 'summary', 'polarity']]
...
# Review the sentiment of a specific positive response
review_positive_sentiment.at[474,'review']
...
# Eliminiate unneccessary columns
summary_positive_sentiment = summary_positive_sentiment[['product','review', 'summary', 'polarity']]
...
# Review the sentiment of a specific response
summary_positive_sentiment.at[335,'review']
...
# The sentiment analysis of the customer reviews of Turtle Games showes positive skewed sentiment scores for both the reviews and summary text, which is a great result for a company. An interesting next step would to look at the polarity scores for individual products to determine which products are performing well and which are not. 
